document.addEventListener('DOMContentLoaded', () => {
    ...
    // Melakukan instance dari object task
                ...
                <div class="task-card flex flex-col gap-5">
                    <div class="flex gap-3 items-center">
                        ...
                        <div class="flex flex-col">
                            <p class="font-bold text-lg leading-[27px]">${capitalizeFirstChar(tasks.taskName)}</p>
                            <p class="text-sm leading-[21px] text-taskia-grey">Created at ${formatDate(tasks.createdAt)}</p>
                        </div>
                    </div>
                    <div class="flex gap-4 font-semibold text-sm leading-[21px]">
                        <div class="flex gap-1 items-center">
                            ...
                            <p>${capitalizeFirstChar(tasks.taskPriority)}</p>
                        </div>
